(function () {
    ...
    */
    ...
    var updateView = function (addAction) { return function (appState) {
        ...
        return wire()(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    <header class=\"header\">\n      <h1>todos</h1>\n      <input class=\"new-todo\" name=\"new-todo\" placeholder=\"What needs to be done?\" autocomplete=\"off\" autofocus onkeypress=\"", "\">\n    </header>\n    ", "\n    ", ""], ["\n    <header class=\"header\">\n      <h1>todos</h1>\n      <input class=\"new-todo\" name=\"new-todo\" placeholder=\"What needs to be done?\" autocomplete=\"off\" autofocus onkeypress=\"", "\">\n    </header>\n    ", "\n    ", ""])), compose(addAction, handleAdd), renderTodoList(addAction, todos.length > 0 && remaining === 0, filtered), renderFooter(addAction, remaining, completed, appState));
    }; };
    ...
    var viewUpdates = chain$$1(raf, map$1(updateView(addAction), stateUpdates));
    var performUpdates = tap$$1(function (update) { return bind(appNode)(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject(["", ""], ["", ""])), update); }, viewUpdates);
    runEffects$$1(performUpdates, scheduler);
